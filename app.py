...
st.markdown("### ❤️ Analyze Your Health")

predict = st.button(
    "Analyze Heart Risk ❤️",
...
Generated using CardioPredict AI
"""
...
<h4>❤️ CardioPredict AI</h4>

Heart Disease Prediction using Machine Learning

Developed by <b>Anshul Rajpoot</b>
